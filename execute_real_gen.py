...
from attention.real_transformer import real_Transformer_Gen
from train_real_gen import train, test_evaluate
...
def execution(load_path=None, train_model=True, best=False, current_date_time=None):
    ...
    model = real_Transformer_Gen(input_dim=input_dim, output_dim=output_dim, embed_dim=320, hidden_dim=2048, num_heads=8, layers=6, tgt_tokens=tgt_tokens, src_tokens=src_tokens)
